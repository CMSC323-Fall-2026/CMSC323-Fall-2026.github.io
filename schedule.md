...
| :--- | :---                                       | :---                                          | :---                                                  |
| 1    | Aug 25: L0 Introduction: <br /> Why programming languages? <br /> Why PLAIT? <br /> Key takeaways <br /> Administrative items <br /><br /> Demo:<br />Factorial <br /> List and list functions <br /> <br />Student Activity: <br />Write a method to find the sum of numbers in a list | Aug 27: L1: PLAIT Syntax<br /> Students please have read lecture notes and come with questions <br /> Demo:<br /> Sum numbers in a list with cond <br /> Cond with more than 2 alternatives (compute a grade given a score)<br /> Higher order functions: map, filter, foldl, and foldr – with anonymous functions, built-in functions and named functions <br /> Creating types – predicates for determining if an object is of a particular type, accessors for that type. <br /> Using type-case -demonstrate how the type-case is better to use than cond <br /> Demo closures, multi-line comments and contracts and tests <br /><br /> Student activity: write Fibonacci number with tail recursion <br /> Write compute-area for shape with cond and class predicates etc <br /> | Aug 28:|
