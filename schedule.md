...
| 2    | Sept 1: [L2 Standard Model of Programming Languages:](lectures/L2_SMOL.pdf)<br /> <br /> <u>Description:</u> Understanding the types of behaviors we will build. <br /> Scope <br /> Order <br /> Mutation <br /><br /> Activities: Exercises within the notes | Sept 3: [L2 Standard Model of Programming Languages:](lectures/L2_SMOL.pdf)<br /> <br /> <u>Description:</u> Functions as values <br /> Local bindings <br /><br /> Activities: Exercises within the notes <br /> <br /> [L3 Evaluators:](lectures/L2_Evaluators.pdf) <br /> <br /> <u>Description:</u> Interpreters and Compilers <br /> AST in PLAIT <br /> Testing our evaluator <br /><br /> Activities: Write expressions in AST <br /> Write tests for interpreter| Sept 4:|
